...
#NEWprivatehostname="RHEL-$PRIVATE_IP-$AVAIL_ZONE-RedHat"
#NEWpublichostname="RHEL-$PUBLIC_IP-$AVAIL_ZONE-RedHat"
...
VarPRI="RHEL-$PRIVATE_IP-$AVAIL_ZONE"-"$INSTANCE_ID"
VarPUB="RHEL-$PUBLIC_IP-$AVAIL_ZONE"-"$INSTANCE_ID"
